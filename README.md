...
│   ├── claims.json           ← the extracted claims + the statements deliberately not claimed
│   ├── flows.json            ← the synthesized flows (ordered groupings of claims)
│   ├── decisions.json        ← user resolutions: dismissed claims + dismissed flows
