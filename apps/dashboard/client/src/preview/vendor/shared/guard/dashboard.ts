...
// Copied from the agentic branch's packages/shared/src/guard/dashboard.ts; delete with the preview.
/**
...
import { z } from 'zod'
import { GuardDriverIdSchema, awaitingDriverIds, type GuardDriverId } from './drivers'
import { GuardOutcomeSchema, GuardFailureDetailSchema, GuardResultStageSchema } from './result'
import type { GuardOutcome, GuardFailureDetail, GuardLatest, GuardTestStatus } from './result'
import {
...
import type { GuardCoverageGapKind, GuardGapDisplayKind } from './report'
import type { GuardScenarioSetupView, GuardScenarioStepView } from './scenario'
import { GuardNeedsSetupSchema } from './needs-setup'
import type { GuardNeedsSetup } from './needs-setup'
import {
