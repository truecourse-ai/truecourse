...
// Copied from the agentic branch's apps/dashboard/client/src/components/guard/GuardFlowDetail.tsx; delete with the preview.
/**
...
import { collapseAuthoringAttempts } from "@/preview/vendor/lib/guard-report";
import {
...
} from "@/preview/vendor/components/guard/GuardTestView";
import {
  GuardDismissedChip,
  GuardFlowStatusChip,
  GuardNotInSpecsChip,
