...
import type { GuardTab } from '@/preview/vendor/hooks/useGuardTabs';
...
/**
 * PREVIEW: the tab strip is RETIRED. In the one-product dashboard a thing opened
 * from a list is its own page (the breadcrumb is the way back), and a list
 * inside a page selects its detail directly, so there is nothing for a strip
 * to hold. The component keeps its contract for the vendored panes that still
 * render it and draws nothing.
 */
export function GuardTabStrip(_props: {
