...
// Copied from the agentic branch's apps/dashboard/client/src/components/guard/GuardDriftDetail.tsx; delete with the preview.
/**
...
import { guardResultRunId } from '@/preview/vendor/shared';
import type { GuardInterfaceRow, GuardRunFlow, GuardScenarioResult } from '@/preview/vendor/shared';
import { guardTestStatusView } from '@/preview/vendor/lib/guard-flow-status';
import { GuardTestView, type GuardTestViewModel } from '@/preview/vendor/components/guard/GuardTestView';
