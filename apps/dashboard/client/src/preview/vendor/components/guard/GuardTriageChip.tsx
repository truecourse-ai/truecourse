...
// Copied from the agentic branch's apps/dashboard/client/src/components/guard/GuardTriageChip.tsx; delete with the preview.
/**
...
import type { GuardTriage, GuardTriageVerdict } from '@/preview/vendor/shared';
