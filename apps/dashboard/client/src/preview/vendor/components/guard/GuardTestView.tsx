...
// Copied from the agentic branch's apps/dashboard/client/src/components/guard/GuardTestView.tsx; delete with the preview.
/**
...
import { renderInlineMarkup } from "@/preview/vendor/lib/inline-markup";
import { formatGuardDuration } from "@/preview/vendor/lib/guard-drifts";
import type { GuardTestStatusView } from "@/preview/vendor/lib/guard-flow-status";
import {
  GuardRunFilmstrip,
  GuardScreenshotLightbox,
  GuardStepScreenshot,
} from "@/preview/vendor/components/guard/GuardEvidenceVisuals";
import { GuardLongText } from "@/preview/vendor/components/guard/GuardLongText";
import { GuardTestSetup } from "@/preview/vendor/components/guard/GuardTestSetup";
import { GuardTriageChip } from "@/preview/vendor/components/guard/GuardTriageChip";
import { GuardVisualChip } from "@/preview/vendor/components/guard/GuardVisualChip";
import { GuardFlowStatusChip } from "@/preview/vendor/components/guard/GuardStatusBadge";
import { PRE } from "@/preview/vendor/components/guard/detail-styles";
