 ...
 *
 * The subject is a ROW of the catalog, not always an interface: a web SCREEN,
 * an api OPERATION, a cli COMMAND. All three wear the same address,
 ...
 * One entry is one invocable thing and the contract union makes that
 * structural, so there is exactly one command to read.
 */
