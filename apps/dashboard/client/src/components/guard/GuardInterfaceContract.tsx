 ...
 * deliberately NOT rendered — implementation traffic, kept to the
 ...
 *
 * There is no second nav here any more. One entry is one invocable thing, so a
 * cli contract carries exactly ONE command — the tree lives in
...
function WebContract({
  ...
  return (
    <div>
      ...
      {/* `apiEffects` is deliberately NOT rendered: the calls a click
 ...
 * any more: one entry is one invocable thing, so a cli contract
