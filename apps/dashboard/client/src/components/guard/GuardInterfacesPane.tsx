 ...
 * place to act at).
 *
 * The pane was ENTRY-scoped before: one interface at a time, its internal id
 * leading, its place, states, sequence and contract rendering as four
...
export function GuardInterfacesPane({
  ...
  /** "mapped 11 Aug 09:18" — when the derivation last ran. */
