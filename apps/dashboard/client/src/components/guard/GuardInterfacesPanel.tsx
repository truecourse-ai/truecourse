 ...
 *    entry IS), and opens onto the page that lists them. It was a subordinate
 *    GROUP of title rows until 2026-08-25, which made three tasks read as a
 *    fourth kind of thing in a panel of screens. Only a SCREENS surface has one:
...
export function GuardInterfacesPanel({
   ...
   * ENTRIES row first. It is a row like any other (2026-08-25): it was a
   * subordinate GROUP of its own, which made three tasks read as a fourth kind of
