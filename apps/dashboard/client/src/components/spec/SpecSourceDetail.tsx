...
import type { SpecSourceDetailView, SpecSourceDoc, SpecSourceSkip, SpecSourceView } from '@/lib/api';
      ...
      <CollapsibleAside label="Source" defaultWidth={320}>
        <div className="shrink-0 border-b border-border bg-card px-3 py-2.5">
          <div className="flex items-center gap-1.5">
            ...
            <span className="min-w-0 flex-1 truncate text-sm font-semibold text-foreground">{summary.title}</span>
          </div>
          <a
          ...
          >
            ...
            <span className="truncate">{summary.llmsTxtUrl}</span>
          </a>
          <div className="mt-1.5 flex flex-wrap items-center gap-1">
            ...
            <span className="text-[10px] text-muted-foreground">fetched {formatGuardTime(summary.fetchedAt)}</span>
          </div>
          <div className="mt-2 flex items-center gap-2">
            ...
            <HoverPopover content="Delete the snapshot and unregister the site" side="bottom" align="start">
              <Button variant="destructive" size="sm" disabled={busy !== null} onClick={onRemove}>
