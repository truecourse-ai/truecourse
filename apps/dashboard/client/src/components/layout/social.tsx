/**
 * Shared community links (GitHub, Discord) and the Discord glyph, used
 * by the header in the community edition and by the enterprise user
 * menu (where these move into the dropdown).
 */
