 ...
 *   - `guard`        — spec-scenario coverage (Coverage · Scenarios · Runs)
 */
...
/** EE Guard tab bar: the full OSS set — Coverage (default) · Scenarios · Runs. */
export const EE_GUARD_TAB_ORDER = ['coverage', 'scenarios', 'guarddrifts'];
