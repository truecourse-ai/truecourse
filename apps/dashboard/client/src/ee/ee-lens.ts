 ...
 *   - `guard`        — spec coverage (Coverage · Flows · Tests · Interfaces · Runs)
 */
...
/** EE Guard tab bar: the full OSS set — Coverage (default) · Flows · Tests ·
 *  Interfaces · Runs. */
export const EE_GUARD_TAB_ORDER = ['coverage', 'guardflows', 'tests', 'interfaces', 'guarddrifts'];
