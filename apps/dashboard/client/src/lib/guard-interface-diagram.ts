...
import { guardDriver, describeWebLocator } from '@truecourse/shared';
import type { GuardDriverId, Interface, InterfaceStep } from '@truecourse/shared';
 ...
 * and the task's own two states are named above the diagram.
 */
