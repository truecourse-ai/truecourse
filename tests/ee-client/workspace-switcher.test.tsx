/**
 * The side menu's workspace switcher, which the enterprise bundle registers in
 * place of the open shell's workspace block.
 *
 ...
 *
 * The whole app is rendered, with this edition registered first, because the
 * point of the seam is that the open shell draws what was registered into it.
 */
