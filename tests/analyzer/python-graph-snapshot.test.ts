...
const SAMPLE_PROJECT_PATH = new URL('../fixtures/sample-python-project', import.meta.url).pathname;
...
describe('graph snapshot — sample-python-project', () => {
  ...
  it('discovers Python files', () => {
    ...
    expect(analyses.every((a) => a.language === 'python')).toBe(true);
  });
