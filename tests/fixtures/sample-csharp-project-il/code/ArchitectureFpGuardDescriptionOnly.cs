...
// `'data-store'` and `''` respectively. The comparator must NOT fire any drift
// for a contract that makes no structured choice.
//
// FP-GUARD: architecture-decision/data-store-unmet-choice — must NOT drift
namespace SampleApi;

internal static class ArchitectureFpGuardDescriptionOnly
{
}
