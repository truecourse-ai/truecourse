/**
 * Guard is a top-level section (Coverage / Tests / Journeys / Runs) and its
...
describe('Guard section — rail tabs', () => {
  it('renders the guard tabs on the rail (Coverage · Tests · Journeys · Runs; no Spec, Scenarios or Generate tab)', () => {
    renderRail();
    for (const label of ['Coverage', 'Tests', 'Journeys', 'Runs']) {
