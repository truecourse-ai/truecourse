 ...
 * never destroy a curated classification (§7.6).
 *
...
/** The three numbers (§3.3): classifying a briefed detection is mostly reading
...
/**
 * The draft the session produces (plan 03 step 10). `condition` is a
 ...
 * variant block alone (§7.6); the human sentence is derived from it at fold.
 *
