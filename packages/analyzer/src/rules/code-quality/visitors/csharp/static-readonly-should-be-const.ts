 ...
 * skips a static-field read, and documents the value as fixed (S3962/CA1802).
...
export const csharpStaticReadonlyShouldBeConstVisitor: CodeRuleVisitor = {
  ...
  visit(node, filePath, sourceCode) {
    ...
    return makeViolation(
      ...
      'A `static readonly` primitive initialized to a literal is a compile-time constant — declare it `const` so the value is inlined and the field read is skipped (S3962/CA1802).',
      sourceCode,
