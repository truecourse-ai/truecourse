 ...
 * referenced assemblies. The check fires on a top-level
...
export const csharpTypeInGlobalNamespaceVisitor: CodeRuleVisitor = {
  ...
  visit(node, filePath, sourceCode) {
    ...
    return makeViolation(
      ...
      `Type \`${name}\` is declared outside any namespace, polluting the global namespace and risking clashes with types from referenced assemblies.`,
      sourceCode,
