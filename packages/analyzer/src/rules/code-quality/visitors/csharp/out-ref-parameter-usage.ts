 ...
 * object. The check fires on a `public` method whose parameter list
...
export const csharpOutRefParameterUsageVisitor: CodeRuleVisitor = {
  ...
  visit(node, filePath, sourceCode) {
    ...
    return makeViolation(
      ...
      `Public method exposes \`${kind}\` parameter \`${paramName}\`, which complicates call sites; prefer a return type or a result object.`,
      sourceCode,
