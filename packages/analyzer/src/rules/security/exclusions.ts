...
export const GLOBAL_ALLOWLIST: RegExp[] = [
  ...
  // Filenames with a recognized document/media/archive/data extension.
  // Composed object keys like `<hash>__<date>__<batch>.pdf` look like
  // high-entropy tokens to pattern detectors, but the trailing extension
  // makes them clearly filenames. Anchored at string end.
