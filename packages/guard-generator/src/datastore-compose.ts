 ...
 *     later run that materializes it. The portable answer is an explicit neutral user
 ...
 * that ran discovery) is a per-machine value in a file every later run reuses.
 */
...
export interface ComposePlan {
  ...
  /** Human-facing notes carried with the recipe's other TODOs. */
  notes: string[]
}
...
function renderCompose(
  ...
  const header = [
    `# ${GUARD_COMPOSE_FILE} — generated by TrueCourse.`,
    '#',
