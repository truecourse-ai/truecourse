...
/**
 * Boot the server once in a throwaway sandbox and wait for health, then stop it.
 * Returns the cli preflight's result shape so the ONE-loud-error paths are shared.
 */
