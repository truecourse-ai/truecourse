...
import { registerKnowledgeGuardRoutes } from './guard-routes.js';
...
export function createKnowledgeRouter(db: EeDb, masterSecret: string, jobs: JobsApi): Router {
  ...
  // --- Scenarios (guard generation over the workspace corpus) ----------------
  registerKnowledgeGuardRoutes(router, { knowledge, jobs });
